 ...
 * for the job.
 *
 * On 32-bit platforms (or with other compilers), we simply error out. Running
 * scientific simulations on 32-bit platforms really makes no sense.
 *
 */
...
#else
#error "Your platform does not support native 128-bit integer."
#endif
