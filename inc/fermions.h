...
// follows we will use b_n and gamma_n interchangeably. These operators satisfy
//   {b_i, b_j} = 2delta_ij
//
...
// use I(i) to stand for the identity matrix at site i.
//
...
public:
    ...
    FermionOp(IndexType N, IndexType n) : SpinOp<FpType>(SpinOp<FpType>::identity()) {
